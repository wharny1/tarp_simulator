...
POLE_HEIGHT = 1.2
# --- CHANGE: Decreased the stretch factor to increase resistance ---
MAX_STRETCH_FACTOR = 1.8 # Lower = stiffer, Higher = stretchier
