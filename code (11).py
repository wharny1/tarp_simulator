    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                elif event.key == pygame.K_e: show_ui = not show_ui # Toggle UI visibility
                ...
                # --- CHANGE: Use A and D for selection ---
        ...
        # --- CHANGE: Only draw the UI if show_ui is True ---
        if show_ui:
